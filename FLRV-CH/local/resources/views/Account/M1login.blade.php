...
<body>
    <div class="row">
        <div id="left"
            style="margin: 0 0 0 0;padding: 0 2px 0 0;background-color: black;;"
            {{--  background-image: linear-gradient(120deg,rgb(53, 53, 226),rgb(74, 77, 65),rgb(243, 83, 195)  --}}
            class="col-md-6 colun-1">
            <div class="box">
                <div class="imgBox"><img src="/FLRV-CH/local/public/assets/img/intro/12.jpg" alt="" srcset=""></div>
                <div class="details">
                    <div class="content">
            ...
            <div class="box">
                <div class="imgBox"><img src="/FLRV-CH/local/public/assets/img/intro/11.jpg" alt="" srcset=""></div>
                <div class="details">
                    <div class="content">
                        <h2 style="color: yellowgreen;">nhanpro</h2>
                        <p>
            ...
            <div class="box">
                <div class="imgBox"><img src="/FLRV-CH/local/public/assets/img/intro/10.jpg" alt="" srcset=""></div>
                <div class="details">
                    <div class="content">
                        <h2 style="color: yellowgreen;">nhanpro</h2>
                        <p>
            ...
            <div class="box">
                <div class="imgBox"><img src="/FLRV-CH/local/public/assets/img/intro/9.jpg" alt="" srcset=""></div>
                <div class="details">
                    <div class="content">
                        <h2 style="color: yellowgreen;">nhanpro</h2>
                        <p>
            ...
            <div class="box">
                <div class="imgBox"><img src="/FLRV-CH/local/public/assets/img/intro/8.jpg" alt="" srcset=""></div>
                <div class="details">
                    <div class="content">
                        <h2 style="color: yellowgreen;">nhanpro</h2>
                        <p>
            ...
            <div class="box">
                <div class="imgBox"><img src="/FLRV-CH/local/public/assets/img/intro/6.jpg" alt="" srcset=""></div>
                <div class="details">
                    <div class="content">
                        <h2 style="color: yellowgreen;">nhanpro</h2>
                        <p>
            ...
            <div class="box">
                <div class="imgBox"><img src="/FLRV-CH/local/public/assets/img/intro/7.jpg" alt="" srcset=""></div>
                <div class="details">
                    <div class="content">
                        <h2 style="color: yellowgreen;">nhanpro</h2>
                        <p>
        ...
        <div style="margin: 0 0 0 0;padding: 0 0 0 0;" class="col-md-6 colun-1">
            <form method="POST" action="account/login" style="margin: auto;padding: 18px 15px 0px 5px;border-bottom: 2px solid blue;background-color: whitesmoke;">
            ...
            <div class="row">
                ...
                <div class="col-md-6 column-2">
                    ...
                    <img style="display: block;" src="/FLRV-CH/local/public/assets/img/logo.png" alt="" srcset="">
